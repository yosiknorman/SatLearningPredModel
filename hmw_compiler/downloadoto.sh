...
do
	...
	cd ${DIR}
    #wget  -c ftp://hmwr829gr.cr.chiba-u.ac.jp/gridded/FD/latest/${y}${m}/TIR/${y}${m}${d}${h}${min}0.tir.01.fld.geoss.bz2
    wget  -c ftp://hmwr829gr.cr.chiba-u.ac.jp/gridded/FD/latest/realtime/${y}${m}${d}${h}${min}0.tir.${NUM}.fld.geoss.bz2
    cd ..
    src="main20.f90"
    cd ..
	exefile="tir.x"
